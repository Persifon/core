...
class AuditLogger:
    ...
    @staticmethod
    def log_user_action(user, action, resource_type=None, resource_id=None, ip_address=None, details=None, request=None):
        """
        Log user actions with flexible parameters.
        """
        description = f"User action: {action}"
        if resource_type:
            description += f" on {resource_type}"
        if resource_id:
    ...
    @staticmethod
    def log_security_event(user, action, description=None, request=None, severity='HIGH', metadata=None, 
                          resource_type=None, resource_id=None, ip_address=None, **kwargs):
        """
        Log security-related events with flexible parameters.
        """
        if not description:
        ...
        if resource_type:
            final_metadata['resource_type'] = resource_type
        if resource_id:
            final_metadata['resource_id'] = resource_id
        if ip_address:
            final_metadata['ip_address'] = ip_address
